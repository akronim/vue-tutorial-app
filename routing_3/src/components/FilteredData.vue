...
export default {
  ...
  // The beforeRouteEnter method is invoked before the component is created,
  // which ensures that navigation can be canceled before the component
  // lifecycle begins.
  async beforeRouteEnter(to, from, next) {
    // slow down the data loading
