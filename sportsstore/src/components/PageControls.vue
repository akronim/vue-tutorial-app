...
export default {
  computed: {
    // mapState and mapGetters are helper functions to provide access
    // to the data store
    ...mapState(["currentPage"]),
    ...mapGetters(["pageCount"]),
    pageNumbers() {
      // generate a sequence of numbers that are used to display
      // buttons for the pages of products
      if (this.pageCount < 4) {
  ...
  methods: {
    // mapActions and mapMutations helpers map methods to a component method
