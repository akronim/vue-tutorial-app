<template>
  <!-- example 17 : stop event propagation -->
  <!-- the stop modifier halts the propagation of an event, preventing it from
  being processed by any subsequent element's v-on directive-->
