<template>
  <!-- example 15 : receiving events in the capture phase -->
  <!-- browser starts with the body element and works its way down the hierarchy
  of elements toward the target-->
